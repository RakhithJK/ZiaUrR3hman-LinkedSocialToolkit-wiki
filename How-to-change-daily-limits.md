By default, daily limit is applied on every function. You can change daily limits. Click the “**Change script settings**” button from  **Linked Social Toolkit** left menu then you will see dialog as below
