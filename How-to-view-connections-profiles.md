**Linked Social Toolkit** accelerates you to attract your target audience and build your network and find leads by viewing prospect profile seamlessly.

You can view 1st, 2nd and 3rd degree connections profiles. Connections gets profile view notification when you view their profile using **Linked Social Toolkit**. Click the “**View connections profile**” button from **Linked Social Toolkit** left menu then you will see dialog as below

![How to view  1st or 2nd or 3rd+ connections profiles on LinkedIn](https://github.com/ZiaUrR3hman/LinkedSocialToolkit/raw/master/images/How-to-view--1st-or-2nd-or-3rd-connections-profiles-on-LinkedIn.png)

## Follow these steps for viewing connection profile
1. Click the “**View connections profile**” button from **Linked Social Toolkit** left menu
2. Apply search filters to find connections profiles you want to view
...
### Delay
Delay between viewing every single profile in seconds.
...
Click the “**Stop script execution**” button from **Linked Social Toolkit** left menu to stop script from viewing connections' profiles.
